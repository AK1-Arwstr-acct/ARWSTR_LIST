<template>
  <div
    class="relative h-screen flex justify-center items-center py-12 px-1 md:px-5 lg:py-16 lg:px-28"
  >
          ...
          >
            ...
            >
              <a
                ...
                class="py-3 px-3.5 bg-[#8380FF] rounded-lg w-full md:w-max text-nowrap"
                target="_blank"
